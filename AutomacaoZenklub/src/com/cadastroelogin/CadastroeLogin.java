...
public class CadastroeLogin {
	...
	public static void main(String[] args) throws Exception {
		...
		// AQUI CLICA NO BOTÃO CADASTRAR GRATIS E DIRECIONA PARA A TELA DE CADASTRO
		...
		// AQUI CLICA NO BOTÃO CRIAR CONTA SEM TER PREENCHIDO NENHUM CAMPO
		 ...
		 // AQUI REALIZA O ASSERT DA MENSAGEM DE PREENCHIMENTO DO CAMPO NOME
		 	
		 	{
		        ...
		        if (!msg1.equals(msgnome)){
		            driver.quit();
		            throw new Exception("Cadastro: A mensagem de validação do campo nome esta incorreta");  }
		        
		        else {
		        	
		        System.out.println("Cadastro: A mensagem de validação do campo nome esta OK");
			 }
			 }
			 {
				
				String msg2 = "Favor preencher um email válido";
				...
				if (!msg2.equals(msgemail)){
		            driver.quit();
		            throw new Exception("Cadastro: A mensagem de validação do campo email esta incorreta");  }
		        
		        else {
		        	
		        System.out.println("Cadastro: A mensagem de validação do campo email esta OK");
			 }
			 }
			 {
				 String msg3 = "Favor preencher uma senha (mínimo de 6 caracteres)";
				 ...
				 if (!msg3.equals(msgsenha)){
			         driver.quit();
			         throw new Exception("Cadastro: A mensagem de validação do campo senha esta incorreta");  }
			        
			     else {
			        	
			     System.out.println("Cadastro: A mensagem de validação do campo senha esta OK");
				}
		...
		// AQUI CLICA NO BOTÃO CRIAR A MINHA CONTA PARA CONCLUIR O CADASTRO
		...
		if(cadastrar != null) {
			...
			// AQUI CLICA NO BOTÃO ENTRAR E DIRECIONA PARA A TELA DE LOGIN
			...
			if(entrar != null) {
				...
				// AQUI CLICA NO BOTÃO ENTRAR SEM TER PREENCHIDO NENHUM CAMPO
				 ...
				 // AQUI REALIZA O ASSERT DA MENSAGEM DE PREENCHIMENTO DE CAMPO
				 	{
						...
						if (!msg4.equals(msgemail1)){
				            driver.quit();
				            throw new Exception("Login: A mensagem de validação do campo email esta incorreta");  }
				        
				        else {
				        	
				        System.out.println("Login: A mensagem de validação do campo email esta OK");
					 }
					 
				 	}
				 	{
				 	
				 	String msg5 = "Senha é necessária";
			        ...
			        System.out.println("Login: A mensagem de validação do campo senha esta OK"); }
				...
				// AQUI CLICA NO BOTÃO ENTRAR E AUTENTICA O USUARIO
